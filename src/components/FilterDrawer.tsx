...
export const FilterDrawer: React.FC<FilterDrawerProps> = ({
  ...
  return (
    /*
      A DIALOG, LIKE EVERY OTHER TOOL. It used to be a drawer sliding in from
      the right — the only panel in the app that did — which made "filters"
      feel like a different application from "settings" or "report a problem".
      Same card, same size, same header, and the two buttons that finish the
      job stay pinned in the footer where a thumb can find them.
    */
    <Sheet
      isOpen
      onClose={onClose}
      ...
      title="Filters"
      subtitle="Land type, distance, road access, water and toilets"
      footer={
