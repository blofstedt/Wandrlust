...
import { X, Mail, Loader2, Check, AlertCircle, Tent, KeyRound, Link2 } from 'lucide-react';
...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-slate-950/80 p-4 anim-backdrop">
      <div className="w-full max-w-sm bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden anim-expand">
